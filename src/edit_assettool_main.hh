...
namespace drnsf {
namespace edit {
namespace assettool_main {

/*
 * edit::assettool_main::tool
 *
 * FIXME explain
 */
...
private:
    ...
    asset_mainctl m_body{ *this, gui::layout::fill() };
...
public:
        ...
        assettool(parent, layout, ctx)
    {
        ...
        m_tracker.on_acquire <<= [this](res::asset *asset) {
            m_body.set_name(asset->get_name());
            set_available(true);
        };

        m_tracker.on_lose <<= [this] {
            set_available(false);
            m_body.set_name(nullptr);
        };
    }
